...
export class PassmasterService {
    ...
    submitPass(pass: Pass): void {
        ...
        console.log('we are going to be posting', JSON.stringify(pass));
        this.http.post(this.apiUrl + 'passes/create/?format=json&type='+pass.type, JSON.parse(JSON.stringify(pass)), httpOptions);
    }
}
